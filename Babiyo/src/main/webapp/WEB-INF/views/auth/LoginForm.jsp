...
<style type="text/css">
	...
	#boxSizeAjdust2 {
		width: 300px; height: 40px; font-size: 16px; cursor: pointer;
		margin-bottom: 20px;
	}
	
	#loginBtnSizeAjdust {
		width: 150px; height: 50px; font-size: 18px; font-weight: bold;
		...
		<div id='titleForm'>
			<form action="./login" method="post">
				...
				<div style="margin-top: 5px; text-align: left;">
					...
					<input type="checkbox" id="together">아이디 저장</label>&nbsp;&nbsp;&nbsp;&nbsp;
				</div>
				<br>
				<br>
				<div>
